...
interface IPreExecutionHook {
    ...
    function preExecutionHook(address filler, ResolvedOrder_1 calldata resolvedOrder) external;
}
...
interface IPostExecutionHook {
    ...
    function postExecutionHook(address filler, ResolvedOrder_1 calldata resolvedOrder) external;
}
