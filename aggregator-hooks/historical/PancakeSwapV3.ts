/**
 * PancakeSwap V3 historical pool discovery.
 * Scans PoolCreated events from the PancakeSwap V3 factory and outputs pool
 * configs in createPools.ts PancakeSwapV3PoolConfig format.
 *
 * Usage:
 *   npx tsx historical/PancakeSwapV3.ts --chain-id 1
 *
 * Options:
 ...
 *
 * Output: JSON array in PancakeSwapV3PoolConfig format.
 */
...
const DEFAULT_FACTORY: Address = '0x0BFbCF9fa4f9C56B0F40a671Ad40E0805A091865';
...
async function main() {
  ...
  const factoryRaw =
    getEnvForChain('PANCAKESWAP_V3_FACTORY', chainId) ?? DEFAULT_FACTORY;
