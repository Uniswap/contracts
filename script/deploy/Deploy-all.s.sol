...
import {MinimalDelegationDeployer} from '../../src/briefcase/deployers/calibur/MinimalDelegationDeployer.sol';
...
contract Deploy is Script {
    ...
    function deployCalibur() private {
        ...
        calibur = address(MinimalDelegationDeployer.deploy(salt));
    }
